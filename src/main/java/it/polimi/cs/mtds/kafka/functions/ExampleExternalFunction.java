...
public class ExampleExternalFunction implements BiFunction<String, AtomicReference<Integer>, String> {

	/**
	 * Return a string consisting in the same characters of the input string, shuffled
	 */
	@Override
	public String apply(String string,AtomicReference<Integer> state) {
